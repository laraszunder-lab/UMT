...
function exp_HistoriqueUMT_1rule0_eval_expression(context) {
    // "Année ret" IS NULL AND "Type efflu" = 'EP'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('Année ret')  === null) && (feature.get('Type efflu')  == 'EP'));
    } else {
        return ((feature.get('Année ret')  === null) && (feature.get('Type efflu')  == 'EP'));
    }
}
...
function exp_HistoriqueUMT_1rule1_eval_expression(context) {
    // "Année ret" IS NULL AND "Type efflu" = 'EU'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('Année ret')  === null) && (feature.get('Type efflu')  == 'EU'));
    } else {
        return ((feature.get('Année ret')  === null) && (feature.get('Type efflu')  == 'EU'));
    }
}
...
function exp_HistoriqueUMT_1rule2_eval_expression(context) {
    // "Année ret" IS NOT NULL AND "Type efflu" = 'EP'
...
function exp_HistoriqueUMT_1rule3_eval_expression(context) {
    // "Année ret" IS NOT NULL AND "Type efflu" = 'EU'
